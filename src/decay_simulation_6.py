...
show_plot = False # show the final plot


# the space of z values for the detector
start, stop, steps = 215, 350, 85
...
def do_experiment(use_scattering, N):
    ...
    if enableMultiProcessing:
        ...
        from decay_simulation_5 import simulate_kaons as sk
